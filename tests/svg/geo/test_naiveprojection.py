...
class TestNaiveProjection(unittest.TestCase):
    ...
    def test_naive_projection(self):
        ...
        self.assertEqual(projection.project(Geopoint(2.32544, 48.88745)), (-128, -58))
        self.assertEqual(projection.project(Geopoint(2.32544, 48.88758)), (-128, 58))
        self.assertEqual(projection.project(Geopoint(2.32573, 48.88745)), (128, -58))
        self.assertEqual(projection.project(Geopoint(2.32573, 48.88758)), (128, 58))
        self.assertEqual(projection.project(Geopoint(2.325585, 48.887515)), (0, 0))
